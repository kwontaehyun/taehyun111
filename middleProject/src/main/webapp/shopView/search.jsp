        ...
        <div class="form_txtInput">
          ...
          <div class="join_form">
            <table>
              ...
              <tbody>
                <tr>
                  <th><p><span>조회 ID</span></p></th>
                  <td><input type="text" name="email" placeholder = "조회할 ID를 입력하세요(email@email.com)">
                      <input type="hidden" name="good" value="search"></td>
                </tr>
                <tr>
                  <th><td><input type="submit" value="검색하기">
                  </td></th>
                </tr>
                </form>
              </tbody>
