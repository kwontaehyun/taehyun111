			...
			<form action="${pageContext.servletContext.contextPath }/update.do"
				...
				<div class="join_form">
						...
						<tbody>
							<tr>
								...
								<td><input type="text" name="email" value="${info.email }"
									readonly style="height:35px; width:150px"></td>
							</tr>
							<tr>
							...
							<tr>
								...
								<th><input id="but" type="submit" value="수정"
									style="margin-top:55px;
									margin-left: 150px; width: 100px; height: 35px; color: #fff; background-color: #6d6969; text-align: center; 
										line-height: 5px;"></th>
					...
					<div class="btn_wrap">
						...
						<a id="homepage"
							href="${pageContext.servletContext.contextPath }/index.jsp">Main
							Page</a>
					</div>
				</div>
				<!-- form_txtInput E -->
