      ...
      <div class="container">
        <div class="form_txtInput">
          <h2 class="sub_tit_txt">📦상품등록📦</h2>
           ...
           <form action="${pageContext.servletContext.contextPath }/productInsert.do" method="post" enctype="multipart/form-data">
            ...
            <table>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td><input type="number" name="price"placeholder = "상품가격을 입력하세요."></td>
                </tr>
                <tr>
                  <th><span>👓카테고리</span></th>
                  <td><input type="text" name="category"placeholder = "카테고리를 입력하세요."></td>
                </tr>
                <tr>
                  <th><span>📃상품설명</span></th>
                  <td><input type="text" name="comment"placeholder = "상품설명을 입력하세요."></td>
                </tr>
                <tr>
                  <th><span>🔮세일</span></th>
