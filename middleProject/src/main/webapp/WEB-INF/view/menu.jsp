			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				...
				<c:choose>
					<c:when test="${!empty email && role == 0}">
						...
						<a class="navbar-brand" id="logout"
							href="javascript:kakaoLogout();">로그아웃</a>
						<form id="form-kakao-logout" method="post"
							action="/middleProject/logout.do"></form>
						<script>
						window.Kakao
						.init("046c047958de0cd3b816a19cdd02fa4b")
							function kakaoLogout() {
								...
								if (!Kakao.Auth.getAccessToken()) {
									document
											.querySelector('#form-kakao-logout')
											.submit();
									return;
								}
								Kakao.Auth
